...
public class Relatorios extends JFrame {
	...
	public Relatorios() {
		...
		txtdatainicio.setBounds(51, 218, 114, 28);
		panel_1.add(txtdatainicio);
		
		 txtdatafinal = new JDateChooser();
		txtdatafinal.setBounds(51, 258, 114, 28);
	...
	private void gravaPdf(RelatorioVendasVO relatorioVendasVO) {
		...
		try {
			...
			document.add(new Paragraph(
					"\nFrangos resfriados vendidos: "+relatorioVendasVO.getResfriados()+"; \nFrangos Congelados:"+relatorioVendasVO.getCongelados()+"; \nFrangos Temperados Vendidos:"
			+relatorioVendasVO.getTemperados()+";\n \nTotal vendido no mês: "+(relatorioVendasVO.getResfriados() + relatorioVendasVO.getCongelados() + relatorioVendasVO.getTemperados())+";"));
