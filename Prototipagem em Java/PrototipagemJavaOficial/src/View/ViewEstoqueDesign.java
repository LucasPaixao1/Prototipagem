...
public class ViewEstoqueDesign extends JFrame {
	...
	public ViewEstoqueDesign(){
		...
		button.setIcon(
				new ImageIcon(ViewEstoqueDesign.class.getResource("/imagens/icons8-gest\u00E3o-de-cliente-25.png")));
		...
		button_4.setIcon(
				new ImageIcon(ViewEstoqueDesign.class.getResource("/imagens/icons8-performance-de-vendas-25.png")));
