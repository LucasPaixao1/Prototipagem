...
public class VendasView extends JFrame {
	...
	public VendasView() {
		...
		btnPreencherCampos
				.setIcon(new ImageIcon(VendasView.class.getResource("/imagens/icons8-cor-de-preenchimento-25.png")));
		btnPreencherCampos.setBounds(325, 16, 182, 28);
		...
		btnAtualizar.setBounds(519, 16, 118, 28);
