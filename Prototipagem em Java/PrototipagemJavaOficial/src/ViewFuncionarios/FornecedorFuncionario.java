...
public class FornecedorFuncionario extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FornecedorFuncionario windowFornecedor = new FornecedorFuncionario();
	...
	private void initialize() {
		...
		btnPesquisar.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-pesquisar-filled-25.png")));
		...
		label.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-p\u00E1gina-inicial-25.png")));
		...
		button_2.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-gest\u00E3o-de-cliente-25.png")));
	...
	button_3 .setMnemonic(KeyEvent.VK_1);
		...
		button_3.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-caminh\u00E3o-25.png")));
		...
		button_4.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-produto-25.png")));
		...
		button_6.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-procurar-estoque-25.png")));
		button_6.setBounds(0, 316, 270, 48);
		...
		button_6.setBackground(new Color(51, 0, 0));

		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(2, 497, 270, 2);

		JLabel lblFuncionrio = new JLabel("Funcion\u00E1rio");
		lblFuncionrio.setBounds(30, 531, 79, 16);
		...
		button_1.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-salvar-25 (2).png")));
		...
		lblCadastroDeFornecedores.setIcon(new ImageIcon(
				FornecedorFuncionario.class.getResource("/imagens/icons8-caminh\u00E3o-interestadual-filled-25.png")));
		...
		btnLimpar.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-vassoura-filled-25.png")));
		...
		frame.getContentPane().add(lblComplemento);
				...
				btnPreencherCampos.setBounds(455, 722, 165, 37);
				...
				btnPreencherCampos
						.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-ver-detalhes-25.png")));
				
						JButton btnAtualizar = new JButton("Atualizar");
						btnAtualizar.setBounds(821, 722, 122, 37);
						...
						btnAtualizar.setIcon(new ImageIcon(FornecedorFuncionario.class.getResource("/imagens/icons8-actualizar-25 (1).png")));
	}
