...
public class VendasView extends JFrame {
	...
	public VendasView() {
		...
		button_2.setIcon(new ImageIcon("F:\\DE TUDO UM POUCO\\TCC\\Prototipagem em Java\\PrototipagemJavaFornecedor\\src\\imagens\\icons8-caminh\u00E3o-25.png"));
		...
		codigo.setBounds(299, 131, 56, 26);
		...
		separator_5.setBounds(575, 50, 80, 2);
